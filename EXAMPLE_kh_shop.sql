...
CREATE USER kh_shop IDENTIFIED BY 6235;
...
COMMENT ON COLUMN CATEGORIES.CATEGORY_ID IS '카테고리 이름';
...
INSERT INTO CUSTOMERS VALUES(1,'홍길동', DEFAULT, '서울시 성동구 왕십리', '010-1111-2222');
