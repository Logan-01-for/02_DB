...
CREATE TABLE "ORDERS"(
				...
				STATUS CHAR(1) DEFAULT 'N' CHECKL(STATUS IN ('Y', 'N')),
				CUSTOMER_ID NUMBER CONSTRAINT FK_CUTOMER_ID REFERENCE CUSTOMERS ON DELETE CASCADE
);
