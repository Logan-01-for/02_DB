...
-- 컬럼 별칭 작성할 것.
CREATE USER kh_shop IDENTIFIED BY your_password;
-- 계정에 CONNECT 권한 부여 (로그인 권한)
GRANT CONNECT TO kh_shop;
CREATE USER kh_shop IDENTIFIED BY your_password
DEFAULT TABLESPACE users 
TEMPORARY TABLESPACE temp;

-- 계정에 RESOURCE 권한 부여 (테이블 생성, 수정 등의 권한)
GRANT RESOURCE TO kh_shop;
...
PRODUCTS_ID VARCHAR2(20),
PRODUCTS_NAME VARCHAR2(100) NOT NULL,
PRODUCTS_CATEGORY NUMBER,-- [FK_CATEGORIES(CATEGORY_ID)],
