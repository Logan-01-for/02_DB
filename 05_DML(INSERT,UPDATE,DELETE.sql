...
-- 윈도우 > 설정 > 연결 > 연결유형 Auto commit by default  체크 해제 되어 있는지 다시 확인
...
-- 2) INSERT INTO 테이블명 (컬럼명1, 컬럼명 2, 컬럼명3..)
...
-- INSERT시 VALUES 대신 서브쿼리 이용하요 삽입하기
...
-- DEPARTMENT2 테이블에서 DEPT_ID가 'D9'인 부서 
...
-- 이를 반영하는 UPDATE문을 서브 쿼리를 이용하여 작성.
